            ...
            <section className="mx-auto py-16">
                <div className="mx-auto max-w-2xl">
                    ...
                    <div className="items-center gap-5 grid sm:grid-cols-2 md:grid-cols-3 mb-8">
                        ...
                        <Card className="bg-accent/20 dark:bg-accent/5 border-border text-center">
                            <CardContent>
                                <Phone className="mx-auto mb-2 size-6 md:size-7 xl:size-8 text-primary" />
                        ...
                        <Card className="bg-accent/20 dark:bg-accent/5 border-border text-center">
                            <CardContent>
                                <MessageSquare className="mx-auto mb-2 size-6 md:size-7 xl:size-8 text-primary" />
                        ...
                        <CardContent>
                            <div className="flex flex-col gap-y-3">
                                ...
                                <div>
                                    ...
                                    <textarea name="message" className="bg-background p-2 px-4 py-3 border border-border rounded-lg focus:outline-none w-full h-24 text-sm md:text-base xl:text-lg duration-300 focus:caret-primary resize-none" value={formData.message} onChange={handleInputChange} placeholder="Tell us how we can help you"></textarea>
                                </div>
                                <Button text="Send Message" disabled={false} loading={false} classNames="rounded-lg" icon={<Send className="size-4 md:size-5 xl:size-6" />} />
                            </div>
                        </CardContent>
                    </Card>
                </div>
