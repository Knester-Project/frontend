export default function Button({ text, loadingText = "Processing...", icon, onClick, variant = "primary", size = "md", disabled = false, loading = false }: FancyButtonProps) {
    ...
    // Variant styles
    const variantStyles = {
        primary: "hover:bg-gradient-to-r bg-primary duration hover:from-primary hover:to-accent text-neutral-200 rounded-2xl",
        secondary: "bg-gradient-to-r from-slate-700 to-slate-900 hover:from-slate-800 hover:to-slate-950 text-white",
        success: "bg-green-400 dark:bg-green-600 text-white rounded-[2rem] hover:bg-green-800 duration-300 hover:text-white",
    }
